...
args = {
    ...
    'num_train_epochs': 20, # 20 better, ori 10
    'weight_decay': 0,
    'learning_rate': 1e-5,
    'adam_epsilon': 1e-8,
    'warmup_ratio': 0,
...
#model = model_class.from_pretrained('/disk/luqh/pretrained_lm/bert-base-uncased')
#tokenizer = tokenizer_class.from_pretrained('/disk/luqh/pretrained_lm/bert-base-uncased')




#model = model_class.from_pretrained('/disk/luqh/pretrained_lm/umlsbert')
#tokenizer = tokenizer_class.from_pretrained('/disk/luqh/pretrained_lm/umlsbert')




#config = config_class.from_pretrained('/disk/luqh/pretrained_lm/albert-xxlarge-v2')
#model = model_class.from_pretrained('/disk/luqh/pretrained_lm/albert-xxlarge-v2', config=config)
#tokenizer = AutoTokenizer.from_pretrained('/disk/luqh/pretrained_lm/albert-xxlarge-v2')


#ptm_model = BertModel.from_pretrained('/disk/luqh/pretrained_lm/bert-base-uncased',output_hidden_states=True)
#tokenizer = BertTokenizer.from_pretrained('/disk/luqh/pretrained_lm/bert-base-uncased')

#ptm_model = BertModel.from_pretrained('/disk/luqh/pretrained_lm/biobertv1.1',output_hidden_states=True)
#tokenizer = BertTokenizer.from_pretrained('/disk/luqh/pretrained_lm/biobertv1.1')


#ptm_model = RobertaModel.from_pretrained('/disk/luqh/pretrained_lm/roberta-base',output_hidden_states=True)
#tokenizer = RobertaTokenizer.from_pretrained('/disk/luqh/pretrained_lm/roberta-base')
...
# = PTMwithAdapterModel(device = device, model = ptm_model, tokenizer = tokenizer, adaptersize = 128, petrained_adaptermodel_path = '/disk/luqh/adapter/code_kumls/pretrained_adaptermodel/albert_umlstriples_adaptermodel_ep1.pt',
#                            freeze_encoder = False, freeze_adapter = False, fusion_mode = 'add')
#model = PTMwithAdapterModel(device = device, model = ptm_model, tokenizer = tokenizer, adaptersize = 128, petrained_adaptermodel_path = '/disk/luqh/adapter/code_kumls/pretrained_adaptermodel/albert_disease_adaptermodel_ep10.pt',
#                            freeze_encoder = False, freeze_adapter = False, fusion_mode = 'add')
#model = PTMwithAdapterModel(device = device, model = ptm_model, tokenizer = tokenizer, adaptersize = 128, petrained_adaptermodel_path = '/disk/luqh/adapter/code_kumls/pretrained_adaptermodel/albert_disease_adaptermodel_ep5.pt',
#                            freeze_encoder = False, freeze_adapter = False, fusion_mode = 'add')

#model = PTMwithAdapterModel(device = device, model = ptm_model, tokenizer = tokenizer, adaptersize = 128, petrained_adaptermodel_path = '/disk/luqh/adapter/code_kumls/pretrained_adaptermodel/albert_umlswithdefi_adaptermodel_skiprate0.9_ep1.pt',
#                            freeze_encoder = False, freeze_adapter = False, fusion_mode = 'add')

#model = PTMwithAdapterModel(device = device, model = ptm_model, tokenizer = tokenizer, adaptersize = 128, petrained_adaptermodel_path = '/disk/luqh/adapter/code_kumls/pretrained_adaptermodel/albert_sgrouping_ep1_lr1e5.pt',
#                            freeze_encoder = False, freeze_adapter = False, fusion_mode = 'add')

#model = PTMwithAdapterModel(device = device, model = ptm_model, tokenizer = tokenizer, adaptersize = 128, petrained_adaptermodel_path = '/disk/luqh/adapter/code_kumls/pretrained_adaptermodel/albert_umlswithoutdefi_LP_ep2_lr1e4.pt',
#                            freeze_encoder = False, freeze_adapter = False, fusion_mode = 'add')
...
#print(model.__class__.__name__) #PTMwithAdapterModel
#exit()
...
#save_adapter_url = '/disk/luqh/adapter/pretrained_adapters/umlstriple/'
#save_adapter_url = '/disk/luqh/adapter/pretrained_adapters/umlstriple_old/'
#save_adapter_url = '/disk/luqh/adapter/pretrained_adapters/umlstriple_margin_1/'
#save_adapter_url = '/disk/luqh/adapter/pretrained_adapters/umlstriple_margin_0.1/'
#model = model_class.from_pretrained(save_adapter_url, output_hidden_states=True)
#model.load_adapter(save_adapter_url)
...
if(model.__class__.__name__ == 'PTMwithAdapterModel' or model.__class__.__name__ == 'PTMwithAdapterModel_fusion'):
    ...
    classificationlLayerMedNLI = classificationlLayer(model.hidden)
else:
...
def train(train_dataset, model, towerModel, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            #print('aaaaaaaaaaaaa')
            #print(next(model.parameters()).device)  # Check model's parameters' device
            #print(inputs['input_ids'].device)        # C
...
def evaluate(model, towerModel, tokenizer, mode, prefix=""):
    ...
    #print(attention_scores_prob_avg.shape)
